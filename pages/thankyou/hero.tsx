        ...
        <div className="grid grid-cols-1 items-center gap-14 md:grid-cols-[40%_60%] md:gap-8">
          ...
          <div className="md:col-auto -mt-25">  
            ...
            <div className="mt-10">
              ...
              {/* Social Icons */}
              <div className="w-104.25 h-17.75 mt-5 flex flex-wrap items-center justify-center gap-4 rounded-2xl border border-gray-200">
          ...
          <div className="relative md:mt-20">
            <div className="grid grid-cols-[25%_50%_25%] grid-rows-2 gap-4 justify-center">
              <div className="h-[305px] w-full overflow-hidden rounded-2xl">
                <img
                  src="/frame1.png"
                  alt="Frame 1"
